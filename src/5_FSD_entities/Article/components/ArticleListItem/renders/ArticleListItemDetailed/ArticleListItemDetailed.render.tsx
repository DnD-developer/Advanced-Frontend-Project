...
import styles from "./ArticleListItemDetailedRender.module.scss"

type ArticleListItemDetailedRenderProps = {
	className?: string
	article: articleListItemStateMap["article"]
	onClickHandler?: () => void
}
export const ArticleListItemDetailedRender = memo<ArticleListItemDetailedRenderProps>(props => {
	...
	return (
		<Card className={classNamesHelp(styles.ArticleListItemDetailed, {}, [className])}>
